    ...
    public partial class frmCari : Form
    {
        ...
        private void tileEdit_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            if (currentyBindingSource.Current == null)
                return;
            using (BarcoS.Classes.Views.EditForms.frmEditCari frm = new BarcoS.Classes.Views.EditForms.frmEditCari(currentyBindingSource.Current as Currenty))
            {
                if (frm.ShowDialog() == DialogResult.OK)
                    ListCurrenties();
            }
        ...
        private void tileDeleteUser_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            if (currentyBindingSource.Current != null)
            {
                ...
                {
                    frmLogin.Log.Info("a Currenty has been deleted, Name:" + (currentyBindingSource.Current as Currenty).auth_name + ", Bakiye:" + (currentyBindingSource.Current as Currenty).bakiye);
